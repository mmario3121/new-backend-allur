    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-tools mb-4">
                <a href="{{ route('admin.carreers.create') }}"
                    ...
                    @forelse($carreers as $carreer)
                        <tr>
                            <td class="btn-row-width-10">
                                <div class="margin">
                                    <div class="btn-group">
                                    <a href="{{ route('admin.carreers.edit', ['carreer' => $carreer]) }}"
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <form
                                            action="{{route('admin.carreers.destroy', ['carreer' => $carreer])}}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
