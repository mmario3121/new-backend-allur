...
@section('title', "Страница $model->title ")

@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <h3 class="m-0">Страница {{$model->title}}</h3>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-tools mb-4">
                <a href="{{ route('admin.sections.create', ['model_id' => $model->id]) }}"
                                ...
                                <div class="margin">
                                    ...
                                    <a href="{{ route('admin.sections.edit', ['section' => $section]) }}"
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <form
                                            action="{{route('admin.sections.destroy', ['section' => $section])}}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
