...
@section('title', "Цвета $model->title ")

@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <h3 class="m-0">Цвета {{$model->title}}</h3>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-tools mb-4">
                <a href="{{ route('admin.colors.create', ['model_id' => $model->id]) }}"
                    ...
                    @forelse($colors as $color)
                        <tr>
                            ...
                            <td class="btn-row-width-10">
                                <div class="margin">
                                    <div class="btn-group">
                                    <a href="{{ route('admin.colors.edit', ['color' => $color]) }}"
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <form
                                            action="{{route('admin.colors.destroy', ['color' => $color])}}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
