    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-tools mb-4">
                <a href="{{ route('admin.careras.create') }}"
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                    @forelse($careras as $carera)
                        <tr>
                            <td class="btn-row-width-10">
                                <div class="margin">
                                    <div class="btn-group">
                                    <a href="{{ route('admin.careras.edit', ['carera' => $carera]) }}"
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <form
                                            action="{{route('admin.careras.destroy', ['carera' => $carera])}}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
